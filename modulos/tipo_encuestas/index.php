<?php 
	...
	if(!empty($_GET['del'])){
		$id=$_GET['del'];
		mysql_query("DELETE FROM tipo_encuestas WHERE id='$id'");
		header('index.php');
	}
?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
							TIPO MATERIALES ENCUESTA INFRAESTRUCTURA
                                    ...
                                    <tbody>
										<?php 
											if(!empty($_POST['buscar'])){
												...
												$pame=mysql_query("SELECT * FROM tipo_encuestas WHERE nombre LIKE '%$buscar%' ORDER BY nombre");	
											}else{
												$pame=mysql_query("SELECT id,codigo,nombre,estado FROM tipo_encuestas  ORDER BY nombre");		
											}		
