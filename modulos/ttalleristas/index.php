<?php 
	...
	if(!empty($_GET['del'])){
		$id=$_GET['del'];
		mysql_query("DELETE FROM TTALLERISTAS WHERE id='$id'");
		header('index.php');
	}
?>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														...
														<h3 align="center" class="modal-title" id="myModalLabel">Nuevo Tipo Tallerista</h3>
													</div>
										<div class="panel-body">
										<div class="row">
								...
								<?php 
									if(!empty($_POST['nombre'])){ 
										...
										if(empty($_POST['id'])){
											...
											$oPaciente->crear();
											echo mensajes('Tipo Tallerista "'.$nombre.'" Creado con Exito','verde');
										}else{
											$id=limpiar($_POST['id']);
											$oPaciente=new Proceso_Paciente($id,$codigo,$nombre,$estado);
											$oPaciente->actualizar();
											echo mensajes('Tipo Tallerista "'.$nombre.'" Actualizado con Exito','verde');
										}
									}
                                    ...
                                    <tbody>
										<?php 
											if(!empty($_POST['buscar'])){
												...
												$pame=mysql_query("SELECT * FROM ttalleristas WHERE nombre LIKE '%$buscar%' ORDER BY nombre");	
											}else{
												$pame=mysql_query("SELECT id,codigo,nombre,estado FROM ttalleristas  ORDER BY nombre");		
											}		
														...
														<div class="modal-content">
															...
															<div class="row" align="center">                                       
																...
																<div class="alert alert-danger">
																	...
																	una vez Eliminado el Tipo Tallerista [ <?php echo $row['nombre']; ?> ]<br> 
