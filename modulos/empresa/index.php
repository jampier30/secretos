				...
				<?php if(permiso($_SESSION['cod_user'],'4')==TRUE){ ?>
					...
					<div class="col-md-6">											
						<i class="icon-chevron-right"></i> <strong>Nombre: </strong><?php echo $row['empresa']; ?><br><br>
                            ...
                            <i class="fa fa-chevron-right"></i> <strong>Moneda: </strong><?php echo $row['moneda']; ?><br><br>
							<i class="fa fa-chevron-right"></i> <strong>Smv: </strong><?php echo $row['smv']; ?>								
					</div>
					<div class="col-md-6">
														...
														<div class="modal-content">
															...
															<div class="row">                                       
																...
																<div class="col-md-6">
																	...
																	<input class="form-control" name="smv" autocomplete="off" required value="<?php echo $row['smv']; ?>"><br>
