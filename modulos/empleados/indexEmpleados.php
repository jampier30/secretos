                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
												<div class="btn-group">
													<button type="button" onclick="formeditPlanCuentas('<?php echo $datosEmpleado;?>')" class="btn btn-default btn-sm" data-toggle="modal" data-target="#ModalEditarPlanCuentasFM"><span class="glyphicon glyphicon-pencil"></span></button>
												</div>
											</td>
                                        </tr>
											<?php }?>       	
