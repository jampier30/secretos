        ...
        <div id="page-wrapper" >
            ...
            <div class="row">           
                ...
                <table class="table table-bordered">
                            ...
                            <div id="imprimeme">                                    	                                   											
										<br>
										<table class="table" width="400px" style="border: 1px dotted #FFFFFF; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
										<?php											
											$pa=mysql_query("SELECT * FROM consultas_medicas WHERE id='$factura'");				
												while($row=mysql_fetch_array($pa)){
													$oPaciente=new Consultar_Paciente($row['id_paciente']);
										...
										?>
						                 <tr>
						                    ...
						                    <tr>
											   <td colspan="4" align="center" class="text-danger" style="font-size: 10px;"></td>
											</tr>
											<tr>
											   <td colspan="4" align="center" class="text-danger" style="font-size: 8px;"></td>																			  										  
											</tr>                       	
						                </table>                                       												 																											
										<table class="table table-striped table-bordered table-hover" width="400px" style="border: 1px dotted #FFFFFF; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
										 <?php											
											...
											?>		
												<tr>
													<td colspan="4" style="font-size: 16px;">
														 <ol>
															<strong><?php echo $row['med1']; ?></strong><br>
															<?php echo $row['indi1']; ?><br>
															
															<strong><?php echo $row['med2']; ?></strong><br>
															<?php echo $row['indi2']; ?><br>
														
															<strong><?php echo $row['med3']; ?></strong><br>
															<?php echo $row['indi3']; ?><br>
															
															<strong><?php echo $row['med4']; ?></strong><br>
															<?php echo $row['indi4']; ?><br>
															
															<strong><?php echo $row['med5']; ?></strong><br>
															<?php echo $row['indi5']; ?><br>
															
															<strong><?php echo $row['med6']; ?></strong><br>
															<?php echo $row['indi6']; ?><br>
															
															<strong><?php echo $row['med7']; ?></strong><br>
															<?php echo $row['indi7']; ?><br>
															
															<strong><?php echo $row['med8']; ?></strong><br>
															<?php echo $row['indi8']; ?><br>
															
															<strong><?php echo $row['med9']; ?></strong><br>
															<?php echo $row['indi9']; ?><br>
															
															<strong><?php echo $row['med10']; ?></strong><br>
															<?php echo $row['indi10']; ?>
										...
										<table class="table" width="400px" style="border: 1px dotted #FFFFFF; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
						                  <tr>
											   <td colspan="4" align="left" class="text-danger" style="font-size: 12px;"></td>
											</tr>
						                 <tr>
						                 	   <td colspan="3" align="left" class="text-danger" style="font-size: 12px;"></td>
											   <td colspan="1" align="left" class="text-danger" style="font-size: 16px;"><?php echo $oPaciente->consultar('nombre'); ?></td>
											</tr>
						                    <tr>
						                    	<td colspan="1" align="left" class="text-danger" style="font-size: 12px;"></td>
						                    	<td colspan="1" align="left" class="text-danger" style="font-size: 12px;"></td>
											   <td colspan="1" align="left" class="text-danger" style="font-size: 16px;"> <?php echo CalculaEdad($oPaciente->consultar('edad')); ?> Años</td>
											   <td colspan="1" align="center" class="text-danger" style="font-size: 14px;"> <?php echo fecha($fecha); ?> </td>
											</tr>
											<tr>
											   <td colspan="4" align="left" class="text-danger" style="font-size: 13px;"></td>																			  										  
											</tr>                       	
						                </table>       																																								                                                                         
                                    </center>
                                </td>
