        ...
        <div id="page-wrapper" >
            ...
            <div class="row">           
                ...
                <table class="table table-bordered">
                            ...
                            <div id="imprimeme">                                    	                                   											
										<br>
										<table class="table table-bordered" width="350px" style="border: 1px dotted #FFFFFF; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
										<?php											
											$pa=mysql_query("SELECT * FROM consultas_medicas WHERE id='$factura'");				
												while($row=mysql_fetch_array($pa)){
													$oPaciente=new Consultar_Paciente($row['id_paciente']);
										...
										<table class="table table-striped table-bordered table-hover" width="350px" style="border: 1px dotted #FFFFFF; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
										 <?php											
